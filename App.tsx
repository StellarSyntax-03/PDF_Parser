...
import { parseCreditCardStatement } from './services/GeminiService'; // ✅ Fixed import path (uppercase G)
      ...
      <main className="w-full max-w-4xl mx-auto flex flex-col items-center">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-lg text-slate-600 max-w-2xl mx-auto">
            Effortlessly extract key data from your credit card statements.
            Powered by Gemini.
          </p>
        </div>
        ...
        <footer className="mt-10 text-center text-sm text-slate-500">
          <p>
            &copy; {new Date().getFullYear()} Statement Parser. All rights
            reserved.
          </p>
        </footer>
      </main>
